...
public class SPHelper {
    ...
    public SPHelper(Context context, String fileName) {
        sharedPreferences = context.getSharedPreferences(fileName, Context.MODE_MULTI_PROCESS);
    }
    ...
    //一次可以传入多个ContentValue对象的值  SPhelper.putValues(new SPHelper.ContentValue("aaa", aaa));
